...
\name{Harsh Dadhich} % used as signature, if no signature is specified

\signature{Harsh Dadhich}

\date{\today}
\subject{\textbf{Statement of Purpose / Personal Statement}\\Program: \textbf{Computer Science M.S.}}
